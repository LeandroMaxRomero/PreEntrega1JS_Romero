...
boton_calorias.addEventListener("click", function(e){
    ...
    function mensaje_usuario(){
        ...
        if(diferencia_kilocalorias > 50){   
            ...
            respuesta.innerHTML = nombre + ": Debe disminuir un promedio de " + Math.round(diferencia_kilocalorias) + " kilocalorías diarias para mantener su peso";
            ...
            let respuesta = document.createElement("p");
            respuesta.innerHTML = nombre + ": Debe aumentar un promedio de " + Math.round(-diferencia_kilocalorias) + " kilocalorías diarias para mantener su peso";
            respuesta.style.fontSize = "16px";
            mensaje.append(respuesta);
        }
